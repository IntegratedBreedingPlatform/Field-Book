...
enum class GeneralKeys(val key: String) {
    ...
    DEFAULT_STORAGE_LOCATION_PROVIDER_TYPE("DEFAULT_STORAGE_LOCATION_PROVIDER_TYPE"),
    DEFAULT_STORAGE_LOCATION_PROVIDER_LABEL("DEFAULT_STORAGE_LOCATION_PROVIDER_LABEL"),
